        ...
        {submitted ? (
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}
            ...
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                <h2 className="text-xl font-bold text-[#1E293B]" style={{ fontFamily: 'var(--font-heading)' }}>{t('title')}</h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              {form.productName && (
                <div className="p-3 bg-[#1E3A5F]/5 rounded-xl">
                  <p className="text-sm text-[#64748B]">{th ? 'สินค้า:' : 'Product:'} <span className="font-medium text-[#1E293B]">{form.productName}</span></p>
                </div>
              )}
              <div>
