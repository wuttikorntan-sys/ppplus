...
const sections: { id: string; titleTh: string; titleEn: string; icon: typeof MapPin; fields: { key: string; labelTh: string; labelEn: string; multiline?: boolean }[] }[] = [
  ...
  },
  {
    ...
    icon: Clock,
    fields: [
      { key: 'location.hours_title', labelTh: 'หัวข้อ', labelEn: 'Section Title' },
      { key: 'location.lunch',       labelTh: 'เวลาเปิด-ปิด (วันธรรมดา)', labelEn: 'Weekday Hours' },
      { key: 'location.dinner',      labelTh: 'เวลาเปิด-ปิด (วันอาทิตย์)', labelEn: 'Sunday Hours' },
      { key: 'location.closed',      labelTh: 'วันหยุด / หมายเหตุ',        labelEn: 'Closed Days / Notes' },
    ],
  },
];
...
const defaults: ContentMap = {
  ...
  'location.closed':      { th: 'ปิดวันหยุดนักขัตฤกษ์',           en: 'Closed on public holidays' },
