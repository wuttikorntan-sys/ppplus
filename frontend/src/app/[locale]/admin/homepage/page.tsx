...
const sections: SectionDef[] = [
  ...
  {
    id: 'team',
    titleTh: 'ทีมงาน (หน้าเกี่ยวกับเรา)',
    titleEn: 'Team Members (About Page)',
    fields: [
      { key: 'team.member1.image', labelTh: 'สมาชิก 1 - รูป', labelEn: 'Member 1 - Image', isImage: true },
      { key: 'team.member1.name', labelTh: 'สมาชิก 1 - ชื่อ', labelEn: 'Member 1 - Name' },
      { key: 'team.member1.role', labelTh: 'สมาชิก 1 - ตำแหน่ง', labelEn: 'Member 1 - Role' },
      { key: 'team.member2.image', labelTh: 'สมาชิก 2 - รูป', labelEn: 'Member 2 - Image', isImage: true },
      { key: 'team.member2.name', labelTh: 'สมาชิก 2 - ชื่อ', labelEn: 'Member 2 - Name' },
      { key: 'team.member2.role', labelTh: 'สมาชิก 2 - ตำแหน่ง', labelEn: 'Member 2 - Role' },
      { key: 'team.member3.image', labelTh: 'สมาชิก 3 - รูป', labelEn: 'Member 3 - Image', isImage: true },
      { key: 'team.member3.name', labelTh: 'สมาชิก 3 - ชื่อ', labelEn: 'Member 3 - Name' },
      { key: 'team.member3.role', labelTh: 'สมาชิก 3 - ตำแหน่ง', labelEn: 'Member 3 - Role' },
      { key: 'team.member4.image', labelTh: 'สมาชิก 4 - รูป', labelEn: 'Member 4 - Image', isImage: true },
      { key: 'team.member4.name', labelTh: 'สมาชิก 4 - ชื่อ', labelEn: 'Member 4 - Name' },
      { key: 'team.member4.role', labelTh: 'สมาชิก 4 - ตำแหน่ง', labelEn: 'Member 4 - Role' },
      { key: 'team.member5.image', labelTh: 'สมาชิก 5 - รูป', labelEn: 'Member 5 - Image', isImage: true },
      { key: 'team.member5.name', labelTh: 'สมาชิก 5 - ชื่อ', labelEn: 'Member 5 - Name' },
      { key: 'team.member5.role', labelTh: 'สมาชิก 5 - ตำแหน่ง', labelEn: 'Member 5 - Role' },
      { key: 'team.member6.image', labelTh: 'สมาชิก 6 - รูป', labelEn: 'Member 6 - Image', isImage: true },
      { key: 'team.member6.name', labelTh: 'สมาชิก 6 - ชื่อ', labelEn: 'Member 6 - Name' },
      { key: 'team.member6.role', labelTh: 'สมาชิก 6 - ตำแหน่ง', labelEn: 'Member 6 - Role' },
    ],
  },
  {
    id: 'pageheaders',
